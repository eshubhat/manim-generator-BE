...
8. The code must start with the line "class MyScene(Scene):" where "MyScene" is the name of the main class in the script and the code must end with MyScene().render() where manim creates the animation of main class i.e. "MyScene".
